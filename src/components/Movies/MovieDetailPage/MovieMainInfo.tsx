...
const MovieMainInfo: React.FC<Props> = ({ movieDetail, movieCredits }) => {
  ...
  return (
    <>
      ...
      <span className="movie-info-text">{new Date(movieDetail.release_date).toLocaleDateString('en-US')} (US) •</span>
